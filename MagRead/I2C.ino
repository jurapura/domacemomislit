...
void initSensor()
{
  ...
  writeTo(HMC5883L_W, MODE_REG, 0x00); // [1:0] operating mode single (01) or continuous mode (00)
  delay(100);
}
...
void readSensor()
{
  byte readings[5];
  float data[2];
  readFrom(HMC5883L_R, DATA_OUTPUT_X_H, 6, readings);
  ...
  Serial.print(" | MagY = "); Serial.print(data[2]/1090.0);
}
