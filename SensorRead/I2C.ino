...
void readSensor()
{
  ...
  Serial.print("AcX = "); Serial.print(data_gyro_accel[0]/16384.0);
  Serial.print(" | AcY = "); Serial.print(data_gyro_accel[1]/16384.0);
  Serial.print(" | AcZ = "); Serial.print(data_gyro_accel[2]/16384.0);
  Serial.print(" | Tmp = "); Serial.print(data_gyro_accel[3]/340.00+36.53); 
  Serial.print(" | GyX = "); Serial.print(data_gyro_accel[4]/131.0);
  Serial.print(" | GyY = "); Serial.print(data_gyro_accel[5]/131.0);
  Serial.print(" | GyZ = "); Serial.print(data_gyro_accel[6]/131.0);
  Serial.print(" | MagX = "); Serial.print(data_mag[0]/1090.0);
  Serial.print(" | MagZ = "); Serial.print(data_mag[1]/1090.0);
  Serial.print(" | MagY = "); Serial.println(data_mag[2]/1090.0);
}
