...
void readSensor()
{
 ...
 /* brojac=brojac+1;
  ...
  gyr_roll=gyr_roll + gy*dT;
  gyr_pitch=gyr_pitch +(gx*cos(acc_roll*(3.1415/180))+gz*sin(acc_roll*(3.1415/180)))*dT;
  gyr_yaw=gyr_yaw+(gy*sin(acc_pitch*(3.1415/180))+gz*cos(acc_roll*(3.1415/180))*cos(acc_pitch*(3.1415/180))-gx*cos(acc_pitch*(3.1415/180))*sin(acc_roll*(3.1415/180)))*dT;
...
// Serial.print(","); Serial.println(data_gyro_accel[2]/16384.0,1);Serial.print(",");
  Serial.print(acc_roll,0);
  Serial.print(","); Serial.print(acc_pitch,0);
  Serial.print("    ");
  Serial.print(gyr_roll,0); //x
  Serial.print(","); Serial.print(gyr_pitch,0);//z
  Serial.print(","); Serial.println(gyr_yaw,0);
  //
